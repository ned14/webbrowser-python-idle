...
# build directory.
TCL_BUILD_LIB_SPEC='-L/src/third_party/tcl-8.6.17/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/src/third_party/tcl-8.6.17'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/src/third_party/tcl-8.6.17/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/src/third_party/tcl-8.6.17/unix/libtclstub8.6.a'
