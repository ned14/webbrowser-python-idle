...
// Callback for handling socket related errors in CJ
var socketErrorCb = null;

function cheerpjFSInit(appUrlPrefix, jarJsOverridePath, loaderPath, useIframe, cb)
{
